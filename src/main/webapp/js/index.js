...
(function () {
  ...
  var option = {
    ...
    yAxis: [{
      ...
      data: ["SUUNTO手表", "华为P20手机", "军拓铁腕心率监测GPS户外功能运动导航智能手表"]
    }, {
      // y轴数据反转，与数组的顺序一致
      inverse: true,
      show: true,
...
(function () {
  ...
  var option = {
    ...
    xAxis: {
      ...
      data: ['腕表 /眼镜 /珠宝饰品', '男装 /运动户外',  '女鞋 /男鞋 /箱包'],
      data: ['腕表 /眼镜 /珠宝饰品', '女装 /大衣',  '美妆 /个人护理'],
      // 去除刻度线
      axisTick: {
        show: false
      },
...
(function () {
  ...
  var option = {
    ...
    xAxis: [{
      ...
      data: ['SUUNTO手表', '华为P20手机', '军拓铁腕运动导航智能手表','SUUNTO手表', '华为P20手机', '军拓铁腕运动导航智能手表','丹尼尔惠灵顿金属表','卡西欧电子手表男','G-SHOCK卡西欧运动防水男士手表']
    }],
    yAxis: [{
      type: 'value',
      axisTick: {
...
(function () {
  $.ajax({
    ...
    success: function (data) {
      ...
      var option = {
        color: ['#60cda0', '#ed8884', '#ff9f7f', '#0096ff',  '#32c5e9', '#1d9dff'],
        tooltip: {
          trigger: 'item',
          formatter: '{a} <br/>{b} : {c} ({d}%)'
        },
