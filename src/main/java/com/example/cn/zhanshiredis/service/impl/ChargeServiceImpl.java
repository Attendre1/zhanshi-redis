...
import com.example.cn.zhanshiredis.dao.ChargeDao;
 ...
 */
@Service
public class ChargeServiceImpl implements com.example.cn.zhanshiredis.service.ChargeService {
    @Autowired
    ChargeDao chargeDao;

    @Override
    public List<ChargeNameValue> findAllCharge() {return chargeDao.findAllCharge(); }
}
